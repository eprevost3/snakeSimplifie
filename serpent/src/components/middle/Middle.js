...
class Middle extends React.Component{
    ...
    moveSnake(){
        ...
        var output = this.nn.getOutputNeuralNet(3, dicWeights, diff)
    ...
    render(){
        return(
            <div id="middle">
                <Commands changeSpeed = {this.changeSpeed}/>
...
// ajouter un compteur, réinitialiser quand on perd le match, mettre un accélérateur de temps (parce que la c'est long)
